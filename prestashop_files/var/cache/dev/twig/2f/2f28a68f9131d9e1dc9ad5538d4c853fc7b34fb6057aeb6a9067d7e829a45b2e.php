...
class __TwigTemplate_6d4d2d32b4e9932006db96b3fb4b8d0218f5eec6faae8d8bf9465ea6eb735de3 extends \Twig\Template
{
    ...
    <div class=\"quicknav-header\">
        ...
        <h2>";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans(($context["title"] ?? $this->getContext($context, "title")), [], "AdminCommon"), "html", null, true);
        echo "</h2>
    </div>
    ...
    <div class=\"quicknav-fixed-bottom navbar-form-footer\">
        ";
        // line 34
        echo ($context["footer"] ?? $this->getContext($context, "footer"));
        echo "
    </div>
</div>
";
